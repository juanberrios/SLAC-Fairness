...
- Given the mixed results of the first round of UMS, we'll try some combination strategies: combining downsampling with valid predictor selection. As of now we are only attempted two combinations.
...
perfPlot %>%
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
```
- It appears the current two combinations aren't any better. They perform similarly to the downsampling UMSs on their own.
